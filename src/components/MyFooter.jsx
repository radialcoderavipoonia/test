...
import footerlogo from "../assets/images/png/footer-page-logo.png";
...
const MyFooter = () => {
  return (
    <>
      <section id="faqs" className="pt-5 bg_footer position-relative z-1">
        <div className="footer_container pt_20">
          <Row className="justify-content-between">
              ...
              <div className="d-flex justify-content-between">
                <div>
                  <img
                    ...
                    className="mw_188 w-100"
                  />
                  <p className="pt-2 ff_raleway fw_400 fs_sm color_white mw_317 opacity_06 m-0">
                    Lorem ipsum dolor sit amet consectetur. Neque turpis
                    pellentesque vulputate ut pharetra sodales nunc.
                  </p>
                  <div className="d-flex align-items-center pt_19">
                    <a
                    ...
                    <a href="https://www.apple.com/in/store" target="_blank">
                      <img
                        src={appstore}
                        alt="app store image"
                        className="mw_130 w-100 pl_6"
                      />
                    </a>
                  </div>
                </div>

                <div className="d-flex d-xl-none d-block flex-column justify-content-center h-100">
                  <div className="pt_14">
                    <a href="#">
                      <svg
                        width="35"
            ...
            <Col xl={8} xs={12}>
              <Row className="pt_36 pb_42 justify-content-between">
                <Col xl={2} lg={3} md={3} sm={4} xs={6}>
                  <ul className="mb-0">
                    <li className="ff_raleway fw_500 fs_sm color_white mb-0">
                      Main
                    </li>
                    <li className="mt_14 ff_manrope fw_400 fs_sm color_white opacity_08 cursor_pointer mb-0">
                      About
                    </li>
                    <li className="mt_10 ff_manrope fw_400 fs_sm color_white opacity_08 cursor_pointer mb-0">
                      Features
                    </li>
                    <li className="mt_10 ff_manrope fw_400 fs_sm color_white opacity_08 cursor_pointer mb-0">
                      Pricing
                ...
                <Col xl={2} lg={3} md={3} sm={4} xs={6}>
                  <ul className="mb-0 pt-sm-0 pt-5">
                    <li className="ff_raleway fw_500 fs_sm color_white mb-0">
                      Dashboard
                    </li>
                    <li className="mt_14 ff_manrope fw_400 fs_sm color_white opacity_08 cursor_pointer mb-0">
                    ...
                    <li className="mt_10 ff_manrope fw_400 fs_sm color_white text_nowrap opacity_08 cursor_pointer mb-0">
                      Sagittis fringilla
                    </li>
                  </ul>
                </Col>
                <Col xl={3} lg={3} md={3} sm={4} xs={6}>
                  <ul className="mb-0 pt-md-0 pt-5">
                    <li className="ff_raleway fw_500 fs_sm color_white mb-0">
                      Other
                    </li>
                    <li className="mt_14 ff_manrope fw_400 fs_sm color_white opacity_08 cursor_pointer mb-0">
            ...
            <Col xl={1} className="d-xl-block d-none">
              <div className="d-flex flex-column justify-content-center h-100">
                <div className="pt_14">
                  <div className="footer_svg_change">
                    <a
        ...
        <div className="pt_18 pb_18">
          <p className="ff_manrope fs_xsm fw_400 color_white opacity_08 m-0 text-center">
